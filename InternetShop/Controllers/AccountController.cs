                ...
                case SignInStatus.Success:
                    {
                        ...
                        if (roles.Contains("Admin")) Session["IsAdmin"] = true;
                        else Session["IsAdmin"] = false;
                        if (roles.Contains("Editor")) ViewBag.IsEditor = true;
                        else ViewBag.IsEditor = false;
                        if (roles.Contains("User")) ViewBag.IsUser = true;
